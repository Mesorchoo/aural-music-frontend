...
export const albumArt = async ( artist, options, cb ) => {

    const load_album_art_from_spotify = await getSetting('load_album_art_from_spotify') || false;
    if ( !load_album_art_from_spotify ) return null;
